...
const Task = ({ id, text, completed, list, onRemove, onEdit, onComplete }) => {
    ...
    const onChangeCheckbox = (element) => {
        onComplete(list.id, id, element.target.checked);
    }

    return (
        <div key={id} className="tasks__items-row">
            <div className="checkbox">
                <input onChange={onChangeCheckbox} id={`check-${id}`} type="checkbox" checked={completed}/>
